...
export const Location = ({ name, description, items, npcs, paths, handleAction }) => {
  console.log('handleAction', handleAction)
  return (
    <div className="max-w-2xl px-8 py-4 mx-auto bg-green-50 rounded-lg shadow-md dark:bg-gray-800">
      ...
      {paths && <ElementList type="Paths" elements={paths} handleAction={handleAction} />}
    </div>
  );
};
