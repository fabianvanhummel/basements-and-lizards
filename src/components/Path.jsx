  ...
  <div className="max-w-2xl px-8 py-4 mx-auto bg-pink-50 rounded-lg shadow-md dark:bg-gray-800">
    <div className="flex items-center justify-between">
      <h1 className="text-xl font-bold text-gray-700 dark:text-white">
        {name ? name : toLocationId /* TODO: use name if this becomes a required field in source json */}
      </h1>
    ...
    <button
      disabled={!reqMet}
      onClick={() => {setLocation(toLocationId)}}
    ...
    >
      {reqMet ? "Follow this path to " + toLocationId : <strike> {"Follow this path to " + toLocationId} </strike> /* TODO: Remove strike if class is updated for disabled UI */}
    </button>
  </div>
);
